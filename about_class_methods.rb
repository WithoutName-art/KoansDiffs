...
class AboutClassMethods < Neo::Koan
  ...
  def test_since_classes_are_objects_you_can_define_singleton_methods_on_themtoo
  ...
  LAST_EXPRESSION_IN_CLASS_STATEMENT = class Dog #:nodoc:
                                         21
                                       end

  def test_class_statements_return_the_value_of_their_last_expression
    assert_equal 21, AboutClassMethods::LAST_EXPRESSION_IN_CLASS_STATEMENT
  end

  # ------------------------------------------------------------------

  SELF_INSIDE_OF_CLASS_STATEMENT = class Dog #:nodoc:
                                     self
                                   end
